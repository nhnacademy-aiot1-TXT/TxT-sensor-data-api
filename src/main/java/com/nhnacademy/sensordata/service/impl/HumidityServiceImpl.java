...
public class HumidityServiceImpl implements HumidityService {
    ...
    public List<HumidityMaxMin> getDailyHumidity() {
        ...
        Query query = QueryBuilder.newQuery(String.format("select * from hourly_extreme_humidity where time >= '%sT00:00:00Z' AND time <= '%sT00:00:00Z'", today, today.plusDays(1)))
                .forDatabase("tig")
                .create();
