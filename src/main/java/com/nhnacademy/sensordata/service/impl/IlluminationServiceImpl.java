...
public class IlluminationServiceImpl implements IlluminationService {
    ...
    public List<IlluminationMaxMin> getDailyIlluminations(String place) {
        ...
        List<IlluminationMaxMin> illuminations = influxDBUtil.getSensorDataList(startTime, endTime, COLLECTION_TYPE, "_hourly", place, IlluminationMaxMin.class);
     ...
     */
    @Override
    public List<IlluminationMaxMin> getWeeklyIlluminations(String place) {
