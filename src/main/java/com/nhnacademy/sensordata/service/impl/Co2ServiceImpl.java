...
public class Co2ServiceImpl implements Co2Service {
    ...
    public List<Co2MaxMinDaily> getDailyCo2() {
        ...
        List<Co2MaxMinDaily> co2List = influxDBUtil.getSensorDataList(startTime, endTime, COLLECTION_TYPE, "_hourly", Co2MaxMinDaily.class);
    ...
    public List<Co2MaxMinWeekly> getWeeklyCo2() {
        ...
        List<Co2MaxMinWeekly> weeklyList = influxDBUtil.getSensorDataList(startTime, endTime, COLLECTION_TYPE, "_daily", Co2MaxMinWeekly.class);

        Co2MaxMinDaily lastHour = influxDBUtil.getLastSensorData(COLLECTION_TYPE, Co2MaxMinDaily.class)
                .orElseThrow(() -> new Co2NotFoundException("Co2 정보를 찾을 수 없습니다"));
    ...
    public List<Co2MaxMinMonthly> getMonthlyCo2() {
        ...
        List<Co2MaxMinMonthly> monthlyList = influxDBUtil.getSensorDataList(startTime, endTime, COLLECTION_TYPE, "_daily", Co2MaxMinMonthly.class);
